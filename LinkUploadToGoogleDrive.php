...
if($_SERVER["REQUEST_METHOD"] == "POST" || isset($_GET['code']) || (isset($_SESSION['access_token']) && $_SESSION['access_token']) ){
	...
	$client->setClientId('88782528270-22mb9s9ah8cmnhnd4us2c7mercv8a7dl.apps.googleusercontent.com');
	$client->setClientSecret('DGv2yfotDNcgK-9mgDNlmNcg');
	//set the URL of this same file & set the same url in google developer console.
	$client->setRedirectUri('http://filestocloud.appspot.com/LinkUploadToGoogleDrive.php');
